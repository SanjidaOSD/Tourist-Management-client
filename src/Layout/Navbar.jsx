        ...
        <div>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <div className="flex">
                        <a className="btn btn-ghost lg:text-4xl lg:flex"><img src={logo2} className="lg:h-[50px] h-[30px] w-[30px] lg:w-[70px] rounded-2xl" alt="" /><span className="text-pink-400 lg:font-bold"><span className="text-pink-700">A</span>dventure<span className="text-pink-700">A</span>tlas</span></a>
                            ...
                            <div className="dropdown dropdown-hover">
                                ...
                                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box">
                                    ...
                                    <li>
                                        ...
                                        <button onClick={logout} className="btn text-white bg-pink-400 hover:bg-slate-600">Logout</button>
                                    </li>
                                </ul>
                            </div>
                            :
                            <Link to='/login'><button className="btn bg-pink-600 hover:bg-pink-400 hover:text-white">Login</button></Link>
                    }
